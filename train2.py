...
def train():
  ...
  tokenizer = AutoTokenizer.from_pretrained(TOKENIZER_NAME, cache_dir='bert_ckpt')
  ...
  if aug_data:
    ...
    train_dataset = load_data("../dataset/train/train_drop_duplicated.csv", rbert)
    train_label = label_to_num(train_dataset['label'].values)
  ...
  train_dataloader = DataLoader(RE_train_dataset, shuffle=True, batch_size=batch_size)
  eval_dataloader = DataLoader(RE_dev_dataset, batch_size=batch_size)
